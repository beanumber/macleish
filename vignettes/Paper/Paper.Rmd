...
Two tree plot datasets is available through `tree_diameter1` and `tree_diameter2`. The datasets present a change in tree diameter over years for two different plots dominated by the parasites Hemlock Woolly Adelgid. 
