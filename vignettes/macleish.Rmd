...
head(whately)
```
In order to use the data from the Machleish weather towers, you must import the data set(s). The name of the data set corresponds to its tower. Note that the data set imported is using averages over 10 minutes. If you need to calculate another time frame, such as hourly or daily, look at the section called "Compute Daily Averages" below.
