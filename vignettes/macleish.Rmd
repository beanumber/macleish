...
author: "Ben Baumer, Rose Goueth, Wencong Li (Priscilla) and Weijia Zhang (Vega)"
date: "04-10-2016"
...
You can download the orginal report as a PDF file from here: [MacLeish Field Station 2015 Weather Report](http://www.smith.edu/ceeds/macleish_monitoring.php)
...
The number of degrees Celsius that the daily mean temperature is below 0 °C. For example, two days with daily mean temperatures of -10 °C and 0 °C have 10 and 0 freezing degree days, respectively. Annual total freezing degree days are calculated by summing all of freezing degree days. 

#### Growing Degree Days
The number of degrees Celsius that the daily mean temperature exceeds 10 °C . For example, two days with daily mean temperatures of 15 °C and 10 °C have 5 and 0 growing degree days, respectively. Annual total growing degree days are calculated by summing all of growing degree days. 

#### Spring Onset Date
The first day of the year where the average high temperature of that day and the previous four days averages 10 °C and no subsequent ve day period until mid-summer has an average high temperature below 6.1 °C. 

#### Last Spring Freeze Date
The last day between January 1st and mid-summer with a low temperature below 0 °C. 

#### First Autumn Freeze Date
The first day a er mid-summer with a low temperature below 0 °C. 

#### Length of the Growing Season
The number of days between the last spring freeze and rst autumn freeze. 

#### Frequency of 1” Precipitation Events
The number of days per year with precipitation of at least one inch (25.4 mm). 

#### Frequency of 2” Precipitation Events
The number of days per year with precipitation of at least two inches (50.8 mm). 

#### Frequency of 3” Precipitation Events
The number of days per year with precipitation of at least three inches (76.2 mm). 
...
## Example 2: Soil Temperature and Moisture
# A plot is needed here! (time series: temperature vs. time)
# Question: Do we want to recreat this part of the original 2015 report? We don't have any soil data.



## Example 3: Wind
# Two plots are needed here! (Wind direction and speed summary for OrchardMet in 2015.)
...
# Two plots are needed here! (Wind direction and speed summary for WhatleyMet in 2015.)
Wind speed and direction varied between the 10 m OrchardMet and the 25 m WhatleyMet. OrchardMet is located in a woodland clearing where winds are buffeted by trees of the forest canopy. Most wind comes from the west and southwest, with 67% of the time less than 1 m/s. Wind speeds did not average over 3 m/s at any time of the year. 
...
# A plot is needed here! (Daily precipitation totals (mm) and cumulative precipitation (mm) recorded at WhatelyMet.)
A total of 1306 mm of precipitation was recorded at WhatelyMet during 2015 (Table 4). Although precipitation is relatively evenly distributed across the year, precipitation totals were highest in June and lowest in March. February and March had the greatest number of precipitation events (Table 4, Figure 4). Annual precipitation accumulated at a low, but fairly steady rate through June (Figure 4). After June rainfall levels increased and total accumulation increased sharply to the end of the calendar year. 
Starting in June a series of large rainfall events (40-50 mm) occurred regularly over the summer (Figure 4). The largest precipitation event in 2015 occurred on September 30th when 113.8 mm (8.7% of the annual total) of precipitation fell. During 2015, there were 15, 25.4 mm (1”) precipitation events; 2, 50.8 mm (2”) precipitation events; and 1, 76.2 mm (3”) precipitation event. 



## Using the Macleish Field Station Geographical Data
## Example 6: Maps
