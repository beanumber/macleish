...
For example, the total Rainfall measurement may be off because someone bumped into the instrument, or because it could have shut off by itself. So graphing this colim of data would be of best interest. To do so, use the code below to plot your data.
