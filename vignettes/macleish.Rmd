...
head() will give you the first 6 readings within the data you are using, so head(whatley) gives you the first six data points within the whatley data set.
...
You can also see whether your data variables have any correlation with one another by interaction plots.
